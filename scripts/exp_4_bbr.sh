...
# output files
declare resultsfile=/home/client/logs/exp_4_${cca}_${loss}_results
...
for ((i=1;i<=${num_runs};i++)) do	
	sudo iperf3 -J --logfile ${resultsfile}_${i}_flow1 -c SERVER_IP -b ${bw} -t ${iperf_time} -i 1 -p ${iperf_port} --get-server-output &
	sleep 15
	sudo iperf3 -J --logfile ${resultsfile}_${i}_flow2 -c SERVER_IP -b ${bw} -t ${iperf_time} -i 1 -p $((${iperf_port}+2)) --get-server-output &
	wait
